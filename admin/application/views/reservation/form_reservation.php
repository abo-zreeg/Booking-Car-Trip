						...
						<div class="widget-main">
							<div class="col-sm-6 padding-left padding-right" style="margin-top:20px;">
							    ...
							    <div class="form-group">
									...
									<input type="text" name="billingAddress" id="billingAddress" class="form-control" value="<?php if(isset($qryBooking['billingAddress1'])){echo $qryBooking['billingAddress1'];} ?>" />
							    </div>
							    <div class="form-group">
								    ...
								    <div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<input type="text" name="billingCity" id="billingCity" class="form-control" value="<?php if(isset($qryBooking['billingCity'])){echo $qryBooking['billingCity'];} ?>" />
										    </div>
										</div>
										<div class="col-sm-4">
											<div class="form-group">
												<label for="billingState">State: </label>
												<input type="text" name="billingState" id="billingState" class="form-control" value="<?php if(isset($qryBooking['billingState'])){echo $qryBooking['billingState'];} ?>" />
										    </div>
										</div>
										<div class="col-sm-4">
											<div class="form-group">
												<label for="billingZip">ZIP: </label>
												<input type="text" name="billingZip" id="billingZip" class="form-control" value="<?php if(isset($qryBooking['billingZip'])){echo $qryBooking['billingZip'];} ?>" />
										    </div>
										</div>
									</div>
								</div>
...
?>
							    ...
							    <div class="form-group ccFieldsDiv">
									<label for="billingCard">Credit Card # : </label>
									<input type="text" name="billingCard" id="billingCard" class="form-control ccField" value="<?php if(isset($qryBooking['ccNumber'])){echo $qryBooking['ccNumber'];} ?>" />
							    </div>
							    <div class="form-group ccFieldsDiv">
								    <div class="row">
										<div class="col-sm-4">
